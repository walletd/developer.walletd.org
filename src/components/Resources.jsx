...
function Resource({ resource }) {
  ...
  return (
    <div
      ...
      className="group relative flex rounded-2xl bg-zinc-50 transition-shadow hover:shadow-md hover:shadow-fuchsia-900/5 dark:bg-white/2.5 dark:hover:shadow-black/5"
    >
      <ResourcePattern {...resource.pattern} mouseX={mouseX} mouseY={mouseY} />
      <div className="absolute inset-0 rounded-2xl ring-1 ring-inset ring-fuchsia-900/7.5 group-hover:ring-fuchsia-900/10 dark:ring-white/10 dark:group-hover:ring-white/20" />
