...
Our team may have meetings where ideas and decisions are made. In order to keep this transparent, where possible, we will endeavour to publish a document that summarises all salient points. All significant decisions around the development focus of the project will be tracked using GitHub issues, for community participation.
