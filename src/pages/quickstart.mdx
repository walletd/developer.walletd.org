...
For the most up-to-date examples for the cryptocurrency functionality, please refer to the following folders:
1. [Mnemonics Examples](https://github.com/walletd/walletd/mnemonics/examples)
1. [Ethereum Examples](https://github.com/walletd/walletd/coins/ethereum/examples)
1. [Bitcoin Examples](https://github.com/walletd/walletd/coins/bitcoin/examples)

Or if you're a Rust OG, feel free to refer to the Rust documentation available at [https://docs.rs/walletd/latest/walletd/](https://docs.rs/walletd/latest/walletd/)
