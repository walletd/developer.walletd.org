...
The group of words in a mnemonic phrase encode in some way the bytes specific to the keys to a new wallet.  
...
### `Bip39Mnemonic` Struct Functions
...
## `Bip39MnemonicType Enum
 	 Represents the different number of words that can be used for a valid Bip39Mnemoniccrate::Bip39Mnemonic
...
### `Bip39MnemonicType` Enum Functions
...
- ### `Spanish`
- ### `English`
	 English is the default, this is the only officially supported language
