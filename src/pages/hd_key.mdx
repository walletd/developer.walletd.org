...
to facilitate Hierarchical Deterministic (HD) wallets. Supports multiple HD key derivation
 paths including BIP44, BIP49, and BIP84. Has support for customization of
 the derivation path.

The HDKey struct is the main entry point to access walletD functionality for the [BIP32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki) compliant HD keys. 
A HDKey helps facilitate the HD Wallet feature. 
